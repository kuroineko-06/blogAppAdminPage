...
export default function NotificationProvier({ children }) {
            ...
            {notification.value
                ? <p ref={notificationRef}
                    className={backgroundColor +
                        " rounded p-2 text-white fixed bottom-14 opacity-0 " +
                        "left-1/2 -translate-x-1/2 transition-all duration-150 ease-linear"
                    }>
                    {notification.value}</p> : null};
        </>
    );
};
